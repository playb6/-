window.onload = async () => {
  ...
  const hacked_statements = ["Yes", "Maybe", "Most Likely", "Highly Probable", "Potentially", "Unlikely But Still Possible", "Almost Certainly", "Definitely", "oh shit ur screwed"];
  ...
  try {
    ...
    const videoData = await fetch("https://www.youtube.com/watch?v=dQw4w9WgXcQ").catch(error);
    ...
    video.oncanplaythrough = async () => {
      ...
      push("ur mom doesnt love u");
      push("You are", "-L Get Trolled");
